...
python -m tools.train configs/bc/mani_skill_point_cloud_transformer.py --gpu-ids=0 \
	--work-dir=./work_dirs/bc_transformer_bucket/ \
	--cfg-options "train_mfrl_cfg.total_steps=150000" "train_mfrl_cfg.init_replay_buffers=" \
	"train_mfrl_cfg.init_replay_with_split=[\"/home/liuchi/zhaoyinuo/ManiSkill-Learn/full_mani_skill_data/MoveBucket/\",\"$model_list\"]" \
	"env_cfg.env_name=MoveBucket-v0" "eval_cfg.num=300" "eval_cfg.num_procs=1" "train_mfrl_cfg.n_eval=150000"
