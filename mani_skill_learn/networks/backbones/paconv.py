...
from mani_skill_learn.paconv_all_util.paconv_util import weight_init, assign_score, get_ed, assign_kernel_withoutk
# from lib.paconv_lib.functional import assign_score_withk as assign_score_cuda
from mani_skill_learn.paconv_all_lib.paconv_lib.functional import assign_score_withk as assign_score_cuda
...
class PAConvCUDA(PAConv):
    ...
    def forward(self, args):
        ...
        # print('weightbank:', self.weightbank.shape)
