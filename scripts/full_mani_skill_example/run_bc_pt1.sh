...
python -m tools.run_rl configs/bc/mani_skill_point_cloud_transformer.py --gpu-ids=3 \
	--work-dir=./work_dirs/bc_point_transformer_drawer/ \
	--cfg-options "train_mfrl_cfg.total_steps=1000" \
	"env_cfg.env_name=OpenCabinetDrawer-v0" "eval_cfg.num=300" "eval_cfg.num_procs=1" "train_mfrl_cfg.n_eval=100"
