...
python -m tools.run_rl configs/bc/bc_mani_skill_PAConv_pointnet++12.py --gpu-ids=3 \
	--work-dir=./work_dirs/bc_paconv_pointnet2_drawer12_0/ \
	--cfg-options "train_mfrl_cfg.total_steps=100000" "train_mfrl_cfg.init_replay_buffers=" \
	"train_mfrl_cfg.init_replay_with_split=[\"./full_mani_skill_data/OpenCabinetDrawer\",\"$model_list\"]" \
