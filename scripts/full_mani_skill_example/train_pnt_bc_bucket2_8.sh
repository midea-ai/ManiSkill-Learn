...
python -m tools.run_rl configs/bc/mani_skill_point_cloud_transformer2.py --gpu-ids=1 \
	--work-dir=./work_dirs/bc_pointnet_transformer_bucket2_8/ \
	...
	"agent.policy_cfg.nn_cfg.matrix_index=8"
