...
python -m tools.run_rl configs/bc/mani_skill_point_cloud_transformer7.py --gpu-ids=3 \
	--work-dir=./work_dirs/bc_pointnet_transformer_chair7/ \
...
# python -m tools.run_rl configs/bc/mani_skill_point_cloud_transformer7.py --gpu-ids=2 \
# 	--work-dir=./work_dirs/bc_pointnet_transformer_door7/ \
# 	--cfg-options "train_mfrl_cfg.total_steps=150000" "train_mfrl_cfg.init_replay_buffers=" \
