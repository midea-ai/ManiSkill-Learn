...
python -m tools.run_rl configs/bc/mani_skill_point_cloud_transformer5.py --gpu-ids=2 \
	--work-dir=./work_dirs/bc_pointnet_transformer_door5/ \
	...
	"env_cfg.env_name=OpenCabinetDoor-v0" "eval_cfg.num=100" "eval_cfg.num_procs=1" "train_mfrl_cfg.n_eval=500"
