...
python -m tools.run_rl configs/bc/mani_skill_point_cloud_transformer10.py --gpu-ids=2 \
	--work-dir=./work_dirs/bc_pointnet_transformer_chair10_6/ \
	...
	"agent.policy_cfg.nn_cfg.matrix_index=6" "agent.batch_size=900"
