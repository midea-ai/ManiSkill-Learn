...
train_mfrl_cfg = dict(
    ...
    init_replay_with_split=[
        './full_mani_skill_data/MoveBucket/',
        '/data2/wk/maniskill/ManiSkill/mani_skill/assets/config_files/bucket_models.yml'
    ])
env_cfg = dict(
    type='gym',
    unwrapped=False,
...
work_dir = './work_dirs/cql_transformer_bucket/CQL'
